...
/**
 * Only the Http Status Codes we need in this site
 * @readonly
 * @enum {number}
 */
export const AnivStatusCodes = {
  OK_200: HttpStatusCodes.OK_200,
  NOT_FOUND_404: HttpStatusCodes.NOT_FOUND_404,
  API_UNAVAILABLE_503: HttpStatusCodes.SERVICE_UNAVAILABLE_503,
}
